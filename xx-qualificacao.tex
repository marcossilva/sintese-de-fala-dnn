...
\section{Questões}
% Questões: a primeira questão parece insuficientemente especificada; qualquer pessoa com um celular ou GPS já ouviu síntese de voz em português, então a pergunta talvez exija outras condições, como o uso de redes neurais ou o fato do usuário não dispor da massa de dados de treino de uma Google por exemplo. Acrescentar na frase "para obter uma convergência mais rápida dos modelos +em português+ com naturalidade similar".
...
\begin{multline}
    AVQI_{03.01}= (4.152 - 0.177*CPPs - (0.006*HNR) - (0.037*Shim)\\ + (0.941*ShdB) + 0.01*Slope + (0.093*Tilt))*2.8902
\end{multline}
